...
const translations = {
  ...
  "nav.acompanyament_personal": { ca: "A. Personal",                             es: "A. Personal" },
  "nav.sessions_gestalt":  { ca: "A. Emocional i Terapèutic",                     es: "A. Emocional y Terapéutico" },
  "nav.nexgestio":         { ca: "NexGestió",                                     es: "NexGestió" },
  "nav.aav":               { ca: "A. Administratiu Vital",                        es: "A. Administrativo Vital" },
  "nav.mos":               { ca: "Mediació i Or. Jurídica Social",                 es: "Mediación y Or. Jurídica Social" },
  "nav.consultoria_entitats": { ca: "Consultoria Entitats Socials",                 es: "Consultoría Entidades Sociales" },
  "nav.acompanyament_gestio": { ca: "A. Gestió Operativa",                           es: "A. Gestión Operativa" },
