...
const translations = {
  ...
  "nav.acompanyament_personal": { ca: "Acompanyament Personal",                  es: "Acompañamiento Personal" },
  "nav.sessions_gestalt":  { ca: "Acompanyament Emocional i Terapèutic",          es: "Acompañamiento Emocional y Terapéutico" },
  ...
  "nav.mos":               { ca: "Mediació i Orientació Social",                  es: "Mediación y Orientación Social" },
  "nav.consultoria_entitats": { ca: "Consultoria per Entitats Socials",            es: "Consultoría para Entidades Sociales" },
  "nav.acompanyament_gestio": { ca: "Acompanyament i Suport en Gestió d'Entitats",  es: "Acompañamiento y Apoyo en Gestión de Entidades" },
